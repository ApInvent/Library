...
{
    public class BorrowBookCommandProcessor : ICommandProcessor
    {
        private readonly Model.Library _library;
        private readonly IRepository _repository;
        private string _pattern = "borrow book uid:(\\d) bid:(\\d)";

        public BorrowBookCommandProcessor(Model.Library library, IRepository repository)
        {
            _library = library;
        ...
        public string Description => "borrow book uid:<user id> bid:<book id>";
